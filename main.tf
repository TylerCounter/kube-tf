...
variable "key-name" {
  default = "tyler-team"   # change here
}

locals {
  name = "tyler-team"   # change here, optional
}
...
resource "aws_instance" "master" {
  ...
  iam_instance_profile = aws_iam_instance_profile.ec2connectprofile-1.name
...
resource "aws_iam_instance_profile" "ec2connectprofile-1" {
  name = "ec2connectprofile-1"
  role = aws_iam_role.ec2connectcli-1.name
}

resource "aws_iam_role" "ec2connectcli-1" {
  name = "ec2connectcli-1"
